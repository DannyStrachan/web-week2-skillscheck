...
let favColors = ['Green', 'Red', 'Orange',]
...
const me = {firstName: 'Danny', 
            superHeroName: 'Danger Dan', 
            homeTown: 'Seattle', 
            superPowers: ['telekenis', 'super intuition', 'teleportation'], 
...
// Next, create a for loop to loop over the array. If any of the colors you chose is 'blue', change it's value to '#4D4DFF' which is 
// just a more appealing color of blue. Outside of the for loop but still inside of setColor, 
...
// Outside of the loop but still in the redactInfo function, run the function redacted() which is a function we created that 
