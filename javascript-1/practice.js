...
// age will be your age as a number. greeter will be a method that returns the string 'Hello! My name is NAMEVALUE and I 
// live in STATEVALUE' with the correct values

const me = {firstName: 'Danny', state: 'Utah', age: 29, greeter: function()(return `Hello! My name is ' + firstName + ' and I live in ' + state`)}
...
// Create a function called 'arrayReverser' that takes in one parameter, arr. Inside of arrayReverser, create an 
// empty array called 'reversed'. Using a for loop, loop over the passed in array in reverse and add each item to the new reversed array. 
...
const total = myNumbers.reduce((accumulator, curentValue)  => accumulator + curentValue)
...
// Did you know that George Foreman has five sons named George? Let's go ahead and change everyone's name in the notGeorge 
// array to George using .map. Call the new array 'forTheLoveOfGeorge'
...
// 		forTheLoveOfGeorge = notGeorge.map(currentValue => item === 'George')
// 	}
// }
...
// 	function notFriend(people) {
// 	return people.friend = false
	
// }
// enemies = people.filter(!false)
